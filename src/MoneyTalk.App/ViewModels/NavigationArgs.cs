...
/// <summary>Navigation parameter for TradeInEditPage — same idea as <see cref="InvoiceEditNavigationArgs"/>.</summary>
public record TradeInEditNavigationArgs(Guid? TradeInId, Guid? CustomerId = null);
